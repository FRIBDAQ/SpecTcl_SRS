...
/* Modified version of the original source code CalibrationFile.cpp
...
// #define TRC_LEVEL TRC_L_DEB
  ...
  void CalibrationFile::loadCalibration(std::string jsonstring)
  {
    ...
    {
      std::cout << "Invalid Json in calibration file." << std::endl;
    }
    ...
    {
      printf("JSON config - invalid json: {%s}", exc.what());
